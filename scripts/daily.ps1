# Daily paper-trading run for every live account: download prices, fill orders,
# maybe re-learn, queue new orders. Run after the US close (16:30 New York time or
# later); output is appended to logs/.
